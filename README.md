...
AgentFlow is an agent orchestration system that answers natural-language stock analysis questions using explicit planning, deterministic execution, validation, and persistent state.

It demonstrates a real agent system with:
